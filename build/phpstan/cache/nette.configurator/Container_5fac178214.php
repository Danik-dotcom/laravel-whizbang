...
class Container_5fac178214 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5fac178214 $container)
			{
	...
	public function createServiceContainer(): Container_5fac178214
	{
		return $this;
	}
